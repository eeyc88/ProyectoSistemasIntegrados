...
Public Class RptMinimoGrupo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OrdenPedido.RptMinimoGrupo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMinimoGrupo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMinimoGrupo = New RptMinimoGrupo
        rpt.Site = Me.Site
        Return rpt
    End Function
