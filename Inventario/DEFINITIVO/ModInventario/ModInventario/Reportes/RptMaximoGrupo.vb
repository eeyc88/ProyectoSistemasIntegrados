...
Public Class RptMaximoGrupo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OrdenPedido.RptMaximoGrupo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMaximoGrupo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMaximoGrupo = New RptMaximoGrupo
        rpt.Site = Me.Site
        Return rpt
    End Function
