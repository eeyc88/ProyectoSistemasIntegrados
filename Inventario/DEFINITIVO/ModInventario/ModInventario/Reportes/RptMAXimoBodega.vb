...
Public Class RptMAXimoBodega
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OrdenPedido.RptMAXimoBodega.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMAXimoBodega
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMAXimoBodega = New RptMAXimoBodega
        rpt.Site = Me.Site
        Return rpt
    End Function
