...
Public Class RptMinimoBodega
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OrdenPedido.RptMinimoBodega.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMinimoBodega
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMinimoBodega = New RptMinimoBodega
        rpt.Site = Me.Site
        Return rpt
    End Function
