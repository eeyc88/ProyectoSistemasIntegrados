...
Public Class RptExistenciasGrupo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptExistenciasGrupo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OrdenPedido.RptExistenciasGrupo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptExistenciasGrupo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptExistenciasGrupo = New RptExistenciasGrupo
        rpt.Site = Me.Site
        Return rpt
    End Function
