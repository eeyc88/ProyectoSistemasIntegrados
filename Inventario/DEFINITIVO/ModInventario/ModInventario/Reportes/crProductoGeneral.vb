...
Public Class crProductoGeneral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OrdenPedido.crProductoGeneral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrProductoGeneral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crProductoGeneral = New crProductoGeneral
        rpt.Site = Me.Site
        Return rpt
    End Function
