...
Public Class crProductoxBodega
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OrdenPedido.crProductoxBodega.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrProductoxBodega
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crProductoxBodega = New crProductoxBodega
        rpt.Site = Me.Site
        Return rpt
    End Function
