...
Public Class RptMaximoProducto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OrdenPedido.RptMaximoProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMaximoProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMaximoProducto = New RptMaximoProducto
        rpt.Site = Me.Site
        Return rpt
    End Function
