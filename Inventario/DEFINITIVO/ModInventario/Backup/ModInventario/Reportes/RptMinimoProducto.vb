...
Public Class RptMinimoProducto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OrdenPedido.RptMinimoProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMinimoProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMinimoProducto = New RptMinimoProducto
        rpt.Site = Me.Site
        Return rpt
    End Function
