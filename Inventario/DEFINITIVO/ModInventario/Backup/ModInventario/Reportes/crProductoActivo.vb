...
Public Class crProductoActivo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OrdenPedido.crProductoActivo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrProductoActivo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crProductoActivo = New crProductoActivo
        rpt.Site = Me.Site
        Return rpt
    End Function
