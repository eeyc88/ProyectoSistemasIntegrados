...
Public Class crGrupoSubgrupo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OrdenPedido.crGrupoSubgrupo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrGrupoSubgrupo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crGrupoSubgrupo = New crGrupoSubgrupo
        rpt.Site = Me.Site
        Return rpt
    End Function
